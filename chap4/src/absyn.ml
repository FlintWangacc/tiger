...
type field = { name : symbol; escape : bool ref; ty : symbol; pos : pos}
...
and exp = VarExp of var
        ...
        | ForExp of symbol (* var *) * bool ref (* escape *) * exp (* lo *) * exp (* high *) * exp (* body *) * pos
        | BreakExp of pos
...
and tydec = { tydec_name : symbol; tydec_ty : ty; tydec_pos : pos}